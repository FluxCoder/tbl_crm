...
|
*/
$config['base_url'] = 'http://tblcrm.test';
...
|--------------------------------------------------------------------------
|
| Pepper string used for custom hashing library
|
| Suggested length:     64
*/
$config['pepper'] = 'Wp912znQR1bV5JJmyxG5JflLTlFOlAtBP6na1Ht1gtXRysl8bXUgMoRvCPG4KO36';
...
|--------------------------------------------------------------------------
|
| These keys are being used within the encryption library
| They are generated by the openssl_random_pseudo_bytes function, and then Base 64 encoded
|
| !IMPORTANT! 
| First key length:     32
| Seconds key length:   64
*/
$config['first_encryption_key'] = 'l95uh4A89byAgERzy3GLSJ8o5DE+iOhw/HYiHr/FAMU=';
$config['second_encryption_key'] = 'f4yBfd3JopprLjr4LdJUDMwk64nCOnWHXSbWnx0ebVTK71gH++Z2NEHFAEiR0U3CvVYHs5VzTIZ/4Rv8ezQ3bg==';
